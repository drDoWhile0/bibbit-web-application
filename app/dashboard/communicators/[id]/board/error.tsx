...
export default function BoardEditorError({
    error,
    unstable_retry,
}: {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
            <div className="bg-white rounded-2xl border border-[#E5E7EB] p-10 max-w-md shadow-sm">
                ...
                <h2 className="text-lg font-bold text-[#2D4A3E] mb-2">Couldn't load the board editor</h2>
                <p className="text-sm text-[#6B7280] mb-6">
                    Something went wrong while loading this communicator's board.
                </p>
                <button
